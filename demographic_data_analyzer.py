...
def calculate_demographic_data(print_data=True):
    ...
    highest_earning_country = rich_people['native-country'].value_counts()
    highest_earning_country_percentage = (rich_people['native-country'].value_counts() / df['native-country'].value_counts()) * 100
